...
using PenYourPrayer.Providers;
using PenYourPrayer.Results;
...
namespace PenYourPrayer.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            PenYourPrayerUser user = await UserManager.FindAsync(new UserLoginInfo(externalLogin.LoginProvider,
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new PenYourPrayerUser()
            {
                ...
                MobilePlatform = model.MobilePlatform,
                PushNotificationID = model.PushNotificationID,
                CreatedWhen = model.CreatedWhen,
                TouchedWhen = model.TouchedWhen
            };

            user.Id = "sdf";
            user.UserName = "sdfsf@sf.sf";
        ...
        public async Task<IHttpActionResult> RegisterExternal(RegisterExternalBindingModel model)
        {
            ...
            var user = new PenYourPrayerUser() { UserName = model.Email, Id = model.Email };
